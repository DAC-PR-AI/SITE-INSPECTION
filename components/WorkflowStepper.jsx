  ...
  const stages = [
    {
      ...
      isComplete: ["QA_QC_PENDING", "QA_QC_APPROVED", "PROJECT_MANAGER_PENDING", "PROJECT_MANAGER_APPROVED", "MANAGER_TECHNICAL_PENDING", "GM_HUG_PENDING", "GM_HUG_APPROVED", "VP_HUG_PENDING", "COMPLETED"].includes(currentStatus),
    ...
    },
    {
      ...
      isComplete: ["PROJECT_MANAGER_PENDING", "PROJECT_MANAGER_APPROVED", "MANAGER_TECHNICAL_PENDING", "GM_HUG_PENDING", "GM_HUG_APPROVED", "VP_HUG_PENDING", "COMPLETED"].includes(currentStatus),
    ...
    },
    {
      ...
      isComplete: ["MANAGER_TECHNICAL_PENDING", "GM_HUG_PENDING", "GM_HUG_APPROVED", "VP_HUG_PENDING", "COMPLETED"].includes(currentStatus),
    ...
    {
      key: "MANAGER_TECHNICAL",
      label: "Manager Technical",
      subtitle: "Technical Review & Sign-off",
      isComplete: ["GM_HUG_PENDING", "GM_HUG_APPROVED", "VP_HUG_PENDING", "COMPLETED"].includes(currentStatus),
      isPending: currentStatus === "MANAGER_TECHNICAL_PENDING",
      isRejected: currentStatus === "REJECTED" && history[history.length - 1]?.role === "Manager Technical",
    },
    {
      key: "GM_HUG",
      label: "GM – HUG",
