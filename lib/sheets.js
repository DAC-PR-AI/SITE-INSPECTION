...
const PROJECTS_CACHE_TTL = 30000; // 30 seconds cache for project list
const INSPECTIONS_CACHE_TTL = 10000; // 10 seconds cache for inspections list
...
async function ensureSheetAndHeaders(sheets, sheetName, headers) {
